        ...
        <div class="content">
            <div class="content-padding">
		        ...
		        <div class="right-block padding-top-big dir-right">
                    ...
                    <div class="ele-padding">
                        <div>
                            <div class="dir-left form-label">To</div>
                            <form:input class="dir-left form-input" path="email" required="required" type="email"/>
                            <div class="clear"></div>
                        </div><br />
                        <div>
                            <div class="dir-left form-label">Cc</div>
                            <form:input class="dir-left form-input" path="email" required="required" type="email"/>
                            <div class="clear"></div>
                        </div><br />
                        <div>
                            <div class="dir-left form-label">Subject</div>
                            <form:input class="dir-left form-input" path="subject" required="required" type="text"/>
                            <div class="clear"></div>
                        </div><br />
                        <div>
                            <div class="dir-left form-label">Attachments</div>
                            <div class="dir-left"><a href="${command.docUrl}">NDA Document</a></div>
                            <div class="clear"></div>
                        </div><br/>       
                        <form:textarea path="emailText" id="emailText" name="emailText" />
                        
                        <div class="padding-top-big">
                            <div class="dir-right form-btn"><a href="${sendEmailUrl}" style="text-decoration: none; color: white;">Send Email</a></div>
